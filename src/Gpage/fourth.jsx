  ...
  return (  
    <div className="start-container">
      ...
      <form className="form-box" onSubmit={handleSubmit}>
        <h2 className="form-title">4. 성격과 좋아하는 것을 알려주세요</h2>
        <div className="form-group">
          <label htmlFor="name">성격</label>
          <input
            type="text"
            id="name"
            placeholder="무뚝뚝한, 나한테만 친절한, 따뜻한, 다정한, 똑똑한"
            value={person}
        ...
        <div className="form-group">
          ...
          <textarea
            id="age"
            className="age-input"
            placeholder="농구, 러닝, 피아노 치기, 조용한 카페 가서 작업하기,작고 귀여운 동물들, 티라미수 케이크"
            value={like}
             onInput={e => {
